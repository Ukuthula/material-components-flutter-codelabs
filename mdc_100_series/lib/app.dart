...
final ThemeData _kShrineTheme = _buildDarkShrineTheme();
...
ThemeData _buildDarkShrineTheme() {
  ...
  return base.copyWith(
    ...
    textTheme: _buildDarkShrineTextTheme(base.textTheme),
    primaryTextTheme: _buildDarkShrineTextTheme(base.primaryTextTheme),
    accentTextTheme: _buildDarkShrineTextTheme(base.accentTextTheme),
